# geem() function - adapted from geeM package by Lee McDaniel and Nick Henderson
#
# I've modified the geem fit object to include components necessary for
# extracting the entire variance-covariance matrix, which I use for MR-GEE
#' @import Matrix
#' @export
geem_Vinv <- function(formula, id, waves=NULL, data = parent.frame(),
  ...
  # calculate Vinv (entire covariance matrix)
  Vinv <- StdErr %*% R.alpha.inv %*% StdErr
